<%-- 
    Document   : purchase
    Created on : 20 Apr, 2021, 1:12:07 PM
    Author     : SHUBHAM
--%>
...
<%
    ...
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("select id,name from supplier where mobile_no=?");
        ...
        pst = con.prepareStatement("insert into purchase (sup_id,sup_name,sup_mobile,pur_bill_no,pur_amount,pur_date,Payment_status) values(?,?,?,?,?,?,?)");
        pst.setInt(1,id);
        pst.setString(2,name);
        pst.setString(3,mobile);
        pst.setString(4,bill_no);
        pst.setInt(5,amount);
...
/*                size: inherit;
    ...
    <body>    
        ...
        <div class="sidenav">
          ...
          <div class="main">    
              <h1>&nbsp;Add Supplier's Bill</h1><br>    
            <form id="sales" method="post" action="#">    
                <label><b>Supplier Mobile No.</b></label>    <br>
                <input type="text" name="mobile" id="mobile" placeholder="Admin Id">    
                <br>
                <label><b>Bill No.</b></label>   <br> 
